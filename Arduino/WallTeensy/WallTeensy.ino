...
// Push Button Pins
#define BU_START_PIN 26
#define BU_FILL_OVEN_PIN 27
#define BU_ENABLE_WIND_PIN 28
#define BU_ENABLE_SUN_PIN 29
#define BU_ENABLE_PLANT_PIN 30
#define BU_BUY_ELECTRICITY_PIN 31
#define BU_SELL_ELECTRICITY_PIN 32

// Potentiometer Pins
#define POT_AIR_SPEED_PIN 14
#define POT_ENERGY_DIST_PIN 15
#define POT_CaCO3_DOSING_PIN 16
#define POT_NaOH_DOSING_PIN 17

// LED Pins
#define LED_GAME_STATUS_PIN 0
#define LED_FILL_OVEN_PIN 1
#define LED_ENABLE_WIND_PIN 2
#define LED_ENABLE_SUN_PIN 3
#define LED_ENABLE_PLANT_PIN 4
#define LED_BUY_ELECTRICITY_PIN 5
#define LED_SELL_ELECTRICITY_PIN 6
#define LED_OVEN_TEMPERATURE_ALARM_PIN 7
#define LED_ACID_EMISSIONS_ALARM_PIN 8
#define LED_CO_EMISSIONS_ALARM_PIN 9
...
void setupVUMeter(){
  pinMode(VU_METER_OVEN_TEMP_PIN, OUTPUT);
  pinMode(VU_METER_ACID_EMISSIONS_PIN, OUTPUT);
  pinMode(VU_METER_CO_EMISSIONS_PIN, OUTPUT);
}
